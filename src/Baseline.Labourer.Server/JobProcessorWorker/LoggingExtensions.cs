...
namespace Baseline.Labourer.Server.JobProcessorWorker
{
    ...
    public static class LoggingExtensions
    {
        ...
        public static void LogDebug(this ILogger logger, ServerContext serverContext, string message, params object[] args)
        {
        ...
        /// <param name="message">The message to log.</param>
        /// <param name="args">Any arguments to log and interpolate into the message string.</param>
        public static void LogDebug(this ILogger logger, WorkerContext workerContext, string message, params object[] args)
        {
        ...
        /// <param name="message">The message to log.</param>
        /// <param name="args">Any arguments to log and interpolate into the message string.</param>
        public static void LogDebug(this ILogger logger, JobContext jobContext, string message, params object[] args)
        {
        ...
        /// <param name="message">The message to log.</param>
        /// <param name="args">Any arguments to log and interpolate into the message string.</param>
        public static void LogInformation(this ILogger logger, ServerContext serverContext, string message, params object[] args)
        {
        ...
        /// <param name="message">The message to log.</param>
        /// <param name="args">Any arguments to log and interpolate into the message string.</param>
        public static void LogInformation(this ILogger logger, WorkerContext workerContext, string message, params object[] args)
        {
        ...
        /// <param name="message">The message to log.</param>
        /// <param name="args">Any arguments to log and interpolate into the message string.</param>
        public static void LogInformation(this ILogger logger, JobContext jobContext, string message, params object[] args)
        {
